...
public class GlobalTasteHandler implements InputCallbackHandler {
    ...
    public GlobalTasteHandler(ReplyMessageService replyMessageService, UserStateService userStateService, TasteMessageService tasteMessageService, GlobalTasteService globalTasteService) {
